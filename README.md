...
This repository has been created to provide an elaborate JSON API for the elements and their intricate attributes.
...
Source : https://github.com/Bowserinator/Periodic-Table-JSON/tree/master
